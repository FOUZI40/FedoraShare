...
unsigned int nStakeMinAge = 6 * nOneHour; // 6 hrs as zero time weight
...
const string strMessageMagic = "FedoraShare Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("FedoraShare-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in FedoraShare
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // FedoraShare: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FedoraShare", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Times 05182016 CS is doing his research work from UUCODP";
        CTransaction txNew;
        txNew.nTime = 1471285871;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1471285877;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 616237; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x77f3c6f9dab2d515c42768a32ca7ef4131fe296230d47671258902ac5236a6fb"));
...
unsigned char pchMessageStart[4] = { 0xbe, 0xf4, 0xeb, 0xa5 };
