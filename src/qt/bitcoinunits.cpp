...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FEDS");
    case mBTC: return QString("mFEDS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("FedoraShares"));
    case mBTC: return QString(QObject::tr("Milli-FedoraShares (1 / 1,000)"));
    default: return QString("???");
    }
}
