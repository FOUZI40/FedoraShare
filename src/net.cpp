...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("FedoraShare-ext-ip");
...
static const char *strDNSSeed[][2] = {
    {"52.9.221.230", "52.9.221.230"},
	{"52.9.225.8", "52.9.225.8"},
	{"120.27.198.28", "120.27.198.28"},
	{"seed.fedorashare.org", "seed.fedorashare.org"},
    {"seed.fedorashare.com", "seed.fedorashare.com"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("FedoraShare-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("FedoraShare-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("FedoraShare-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("FedoraShare-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FedoraShare is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("FedoraShare-start");
