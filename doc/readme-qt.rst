FedoraShare-qt: Qt4 GUI for FedoraShare
===============================
...
Alternatively, install Qt Creator and open the `FedoraShare-qt.pro` file.

An executable named `FedoraShare-qt` will be built.
...
A warning for people using the *static binary* version of FedoraShare on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of FedoraShare is linked against libdb5.3.
...
installed causes FedoraShare-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
